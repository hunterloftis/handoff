...
BlitRenderer.prototype.render = function(seconds, entities) {
  ...
  // Draw the dudes
  dudes.sort(byPY)
  dudes.forEach(this.renderShadow.bind(this));
  dudes.forEach(this.renderDude.bind(this));
...
BlitRenderer.prototype.renderShadow = function(state) {
...
BlitRenderer.prototype.renderDude = function(state) {
