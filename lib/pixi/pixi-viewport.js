function PixiViewport(container) {
  ...
  this.stage = new PIXI.Stage(0x97c56e, false);
...
PixiViewport.prototype.getRectFor = function(doContainer) {
  var tlLocal = doContainer.toLocal(new PIXI.Point(0, 0), this.normalized);
  var brLocal = doContainer.toLocal(new PIXI.Point(this.width, this.height), this.normalized);
  return {
    left: tlLocal.x,
    top: tlLocal.y,
    right: brLocal.x,
